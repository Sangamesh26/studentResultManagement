...
<%
  ...
  ResultSet rs=st.executeQuery("select *from student inner join marks where student.rollNo=marks.rollNo and student.rollNo='"+rollNo+"'");
  if(rs.next()){
%>
<img src="logo.png"  align="left"width="150" height="150">
<center>
<img src="apj sir.png" align="right"  width="150" height="150"></center>
    <a href="resultsShow.html">Back</a>
  <hr class="new1">
<style>
...
Designed & Developed by Sangamesh</h6></center>
  <hr class="new1">
<center><h6>All Right Reserved @ Sangamesh</h6></center> 
  <hr class="new1">
</body>
<%}
  else
{
	response.sendRedirect("resultsShow.html");
}
